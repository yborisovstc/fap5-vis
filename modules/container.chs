ContainerMod : Elem {
    ...
    ClAddColumnS : Socket3Extd {
        Enable : CpStateInp
        Name : CpStateInp
        # "Pos : CpStateInp"
        Done : CpStateOutp
    }
    ClReposWdgSm : Socket3Extd {
        Enable : CpStateOutp
        Name : CpStateOutp
        # "New column pos"
        ColPos : CpStateOutp
